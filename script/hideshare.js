    ...
    Hideshare.prototype = {
        ...
        wrapHideshare: function() {
            var output = output,
                ...
                facebookTemplate = '<li><a class="hideshare-facebook" href="#"><span>Facebook</span></a></li>',
                twitterTemplate = '<li><a class="hideshare-twitter" href="#"><span>Twitter</span></a></li>',
                googleplusTemplate = '<li><a class="hideshare-google-plus" href="#"><span>Google Plus</span></a></li>',
                linkedinTemplate = '<li><a class="hideshare-linkedin" href="#"><span>Linked In</span></a></li>';
            ...
            this.$wrap.find(".share_link--face").click(function() {
                shareFacebook();
                return false;
            });
            ...
            this.$wrap.find(".share_link--google").click(function() {
                shareGooglePlus();
                return false;
            });

            this.$wrap.find(".share_link--link").click(function() {
                shareLinkedIn();
                return false;
            });
